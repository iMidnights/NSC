...
export default function Example() {
  return (
    ...
    <div className="relative isolate">
      <svg
        className="absolute inset-x-0 top-0 -z-10 h-[48rem] w-full stroke-gray-300 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
        aria-hidden="true"
      >
        <defs>
          <pattern
  ...
  
  {
    services.map((section, sectionIdx) => (
      <section
        id={section.href.replace("/services'", "")}
        className='bg-white py-24 sm:py-32 min-h-dvh text-black'
      >
        {section.title}
      </section>
    ))
