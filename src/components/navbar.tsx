...
import { ArrowTopRightOnSquareIcon, Bars3Icon, BellIcon, XMarkIcon } from '@heroicons/react/24/outline'
...
export default function Navbar({ current = "Home" }: { current?: string }) {
    ...
    const pages = [
        ...
        {
            name: <div className='flex gap-x-2  items-center'>Book Online<ArrowTopRightOnSquareIcon className="h-4 w-4" aria-hidden="true" /></div>,
                    ...
                    pages.map((page, index) => (
                      <a
                        ...
                        className={classNames(
                          current === page.name ? 'border-primary-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700',
              ...
              {/* Current: "bg-primary-50 border-primary-500 text-primary-700", Default: "border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800" */}
              {
                    pages.map((page, index) => (
                      <DisclosureButton
                        ...
                        target={page?.target || "_self"}
                        className={classNames(
                          current === page.name ? 'bg-primary-50 border-primary-500 text-primary-700' : 'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800',
